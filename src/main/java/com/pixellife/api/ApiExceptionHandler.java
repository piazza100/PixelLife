...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(RestClientResponseException.class) @ResponseStatus(HttpStatus.BAD_GATEWAY)
    Map<String,String> billingProviderError(RestClientResponseException ex) {
        return error("BILLING_PROVIDER_ERROR", "Could not open the billing page. Please check your subscription status.");
    }
